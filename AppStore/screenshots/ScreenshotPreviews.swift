    ...
    var screenshot5: some View {
        ZStack {
            ...
            VStack(spacing: 24) {
                ...
                .background(LinearGradient(colors: [.accentColor, .accentColor.opacity(0.6)], startPoint: .topLeading, endPoint: .bottomTrailing))
        ...
        VStack(alignment: .leading, spacing: 6) {
            ...
            GeometryReader { geo in
                ZStack(alignment: .leading) {
                    ...
                    RoundedRectangle(cornerRadius: 4).fill(.accent).frame(width: geo.size.width * weight, height: 8)
                }
            }.frame(height: 8)
        }
    }
